 ...
 * BaseService接口
 */
public interface BaseService<Record, Example,PK> {
     ...
     * @return
     */
    PageInfo<Record> selectByExampleWithBLOBsForStartPage(Example example, Integer pageNum, Integer pageSize);
     ...
     * @return
     */
    Record selectByPrimaryKey(PK id);
