package com.hqh.mybatis.util;

import com.hqh.common.util.AESUtil;
import com.hqh.common.util.StringUtil;
import com.hqh.common.util.VelocityUtil;
...
import static com.hqh.common.util.StringUtil.lineToHump;
	...
	public static void generator(
		...
		for (int i = 0; i < tables.size(); i++) {
			...
			if (!serviceFile.exists()) {
				...
				context.put("modelIdType","Integer");
