 ...
 * 
 */
package com.hqh.mybatis.plugin.cache.provider;

import com.hqh.mybatis.plugin.cache.CacheProvider;
...
public abstract class AbstractCacheProvider implements CacheProvider {
	...
	// 计算关联key集合权重的基数
	protected long baseScoreInRegionKeysSet = System.currentTimeMillis() / 1000 - 60 * 60 * 24 * 7;
