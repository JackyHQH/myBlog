...
import com.hqh.mybatis.plugin.pagination.PaginationHandler;
import com.hqh.mybatis.plugin.rwseparate.RwRouteHandler;
...
public class JeesuiteMybatisInterceptor implements Interceptor,DisposableBean{
	...
	protected static final Logger logger = LoggerFactory.getLogger("com.hqh.mybatis");
