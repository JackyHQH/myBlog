...
public class MybatisPluginProperties {
	...
	public void setGlobalTransactional(boolean globalTransactional){
		properties.setProperty(MybatisConfigs.CACHE_DYNAMIC_EXPIRE, String.valueOf(globalTransactional));
	}
